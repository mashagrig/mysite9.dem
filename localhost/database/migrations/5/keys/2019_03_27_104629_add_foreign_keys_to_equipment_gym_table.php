...
class AddForeignKeysToEquipmentGymTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('equipment_id', 'fk_equipment_gym_equioment_id')->references('id')->on('equipments')->onUpdate('CASCADE')->onDelete('CASCADE');
	...
	public function down()
	{
		Schema::table('equipment_gym', function(Blueprint $table)
		{
			$table->dropForeign('fk_equipment_gym_equioment_id');
