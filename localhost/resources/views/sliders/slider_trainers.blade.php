...
<div class="site-section block-14 bg-light nav-direction-white">
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="site-section-heading text-center">Лучшая тренерская команда в фитнес-клубе Sport</h2>
            </div>
        </div>
            ...
            <div class="p-5">
                <div class="d-flex block-testimony">
                    <div class="person mr-3">
                        <img src="{{ asset("images/person_1.jpg") }}" alt="" class="img-fluid rounded-circle">
                    </div>
                    <div>
