        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 ml-auto">
                    ...
                    <p><a href="#" class="btn btn-secondary py-2 px-4">Join Our Club</a></p>
                </div>
            </div>
        </div>
    </div>

    <div class="site-section bg-image" style="background-image: url('{{ asset("images/bg_2.jpg") }}'); background-attachment: fixed">
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-12">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 text-center">
                    <img src="{{ asset("images/person_3.jpg") }}" alt="Image" class="img-fluid rounded-circle w-25 mb-4">
                ...
                <div class="p-5">
                    <div class="d-flex block-testimony">
                        <div class="person mr-3">
                            <img src="{{ asset("images/person_1.jpg") }}" alt="Image" class="img-fluid rounded-circle">
                        </div>
                        <div>
